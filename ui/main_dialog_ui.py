...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.lbl_lnk = QtGui.QLabel(self.centralwidget)
        self.lbl_lnk.setOpenExternalLinks(True)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lbl_lnk.sizePolicy().hasHeightForWidth())
        self.lbl_lnk.setSizePolicy(sizePolicy)
        self.lbl_lnk.setMinimumSize(QtCore.QSize(290, 0))
        self.lbl_lnk.setMaximumSize(QtCore.QSize(290, 16777215))
        self.lbl_lnk.setText(_fromUtf8(""))
        self.lbl_lnk.setObjectName(_fromUtf8("lbl_gnr"))
        self.gridLayout.addWidget(self.lbl_lnk, 5, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.lbl_yr, 4, 4, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_6.setText(_translate("MainWindow", "Discogs:", None))
